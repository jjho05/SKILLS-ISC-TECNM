...
## 1. Introducción: Anatomía de una Página
...
### 1.1 El Esqueleto Mínimo Válido
Todo documento HTML5 profesional debe tener al menos esto:
...
## 2. El DOCTYPE: La Declaración de Identidad

### 2.1 ¿Qué es?
No es una etiqueta HTML. Es una instrucción al navegador que dice: "Este documento sigue las reglas de HTML5".
Debe ser la **primera línea**, sin espacios ni saltos de línea antes.

### 2.2 Historia y Evolución
*   **HTML 4.01 (Eñ año 1999):**
    `<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">`
    Una pesadilla de memorizar. Referenciaba a un archivo DTD externo (Document Type Definition).
*   **HTML5 (2014):**
    `<!DOCTYPE html>`
    Simple. Case-insensitive (funciona `<!doctype html>`).

### 2.3 ¿Qué pasa si lo quito?
El navegador entra en **Quirks Mode** (Modo Rarezas).
*   Simula ser Internet Explorer 5.5.
*   El cálculo de anchos y altos (Box Model) cambia.
*   `margin: 0 auto` para centrar deja de funcionar en algunos casos.
*   **Conclusión:** NUNCA lo olvides.

---

## 3. El Elemento Raíz: `<html>`

Todo lo demás vive dentro de aquí. Es el nodo raíz del árbol DOM.

### 3.1 El atributo `lang`
`<html lang="es">`
...
Define cómo se interpretan los bytes del archivo.
*   Si lo olvidas, el navegador intentará adivinar. Si adivina mal, verás  o caracteres chinos en lugar de tildes (Mojibake).
*   Debe estar en los primeros 1024 bytes del archivo.

### 4.2 `<meta name="viewport">`
Esencial para móviles.
`content="width=device-width, initial-scale=1.0"`
*   `width=device-width`: El ancho de la página es el ancho de la pantalla del celular. Sin esto, el iPhone simula una pantalla de escritorio de 980px y lo ves todo minúsculo (zoom out).
*   `initial-scale=1.0`: Zoom inicial al 100%.

### 4.3 `<title>`
El título que aparece en la pestaña del navegador y en los resultados de Google.
*   **SEO:** Es el factor más importante On-Page.
*   **UX:** Ayuda al usuario a encontrar la pestaña entre 50 abiertas.

---

## 5. Vinculando Recursos: `<link>`
...
### 5.3 Preload y Prefetch (Performance)
...
## 7. Metadatos Sociales (SEO Social)

Cuando compartes tu link en WhatsApp o Facebook, ¿cómo saben qué foto y título mostrar?
Gracias a **Open Graph (OG)** y **Twitter Cards**.

### 7.1 Open Graph (Facebook, LinkedIn, WhatsApp)
```html
<meta property="og:title" content="Mi Increíble Web">
<meta property="og:description" content="Aprende desarrollo web fácil.">
<meta property="og:image" content="https://miweb.com/foto-grande.jpg">
...
```
*Validación:* Usa el [Facebook Sharing Debugger](https://developers.facebook.com/tools/debug/) para probar esto antes de lanzar.

---

## 8. Atributos Globales: Las Herramientas Universales
...
## 9. Seguridad en el Head: Content Security Policy (CSP)

El ataque XSS (Cross Site Scripting) es el más común en la web. CSP es tu escudo.

### 9.1 ¿Qué es?
Es una instrucción que le dice al navegador: "Solo confía en scripts que vengan de MI dominio. Bloquea todo lo demás".

### 9.2 Implementación
Se puede poner en el servidor (HTTP Header) o en el HTML:
```html
<meta http-equiv="Content-Security-Policy" 
      content="default-src 'self'; img-src https://*; child-src 'none';">
```
*   `default-src 'self'`: Solo carga archivos de mi propio sitio.
*   `img-src https://*`: Carga imágenes de cualquier sitio seguro.
*   **Efecto:** Si un hacker logra inyectar `<script src="hacker.com/virus.js">`, el navegador leerá la CSP, verá que `hacker.com` no está en la lista blanca y **bloqueará la descarga**.

---

## 10. Performance Avanzado: Resource Hints
...
## 11. El Mundo Caótico de los Favicons
...
## 12. Laboratorio de Código: El Head Perfecto
...
## 16. Internacionalización (i18n): `hreflang`
...
## 18. PWA Manifest: El Puente a Nativo
...
## 19. Seguridad de Subrecursos (SRI)
...
## 21. Laboratorio de Código: Depuración de Sensores
...
## 23. La Red de Seguridad: `<noscript>`
...
## 27. La Guía Definitiva de Favicons (2025)
